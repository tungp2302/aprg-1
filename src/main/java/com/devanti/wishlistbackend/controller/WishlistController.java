...
public class WishlistController {
    ...
    public ResponseEntity<String> addItem(@RequestBody WishlistItemRequest request,
        ...
        try {
            // Wunsch mit Zusatzinfos und Bild hinzufügen (imageUrl könnte null sein)
            wishlistService.addItemToWishlist(user, request.getItemName(), request.getItemDetails(), request.getImageUrl());
